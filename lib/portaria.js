...
const esc = (s) => String(s ?? "").replace(/[&<>"']/g,
  (c) => ({ "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" }[c]));
/* Dentro de <script> o perigo é outro: JSON.stringify escapa aspas, mas não o
   "<" de um "</script>" — o endereço pedido fecharia o bloco e o resto viraria
   HTML. < é "<" para o JS e nada para o parser de HTML. */
const escJs = (v) => JSON.stringify(v).replace(/</g, "\\u003C")
  .replace(/\u2028/g, "\\u2028").replace(/\u2029/g, "\\u2029");
