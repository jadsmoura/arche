...
export { EDITAL, LINHAS, GRUPOS_PESQUISA, FOMENTOS, linhaDe, pontuarProducao, fomentoDe, modalidadePor };
...
export function normalizarProjeto(bruto, { base = null, autor = null, agora = new Date() } = {}) {
  ...
  return {
    ...
    // a proposta é que se liga ao grupo, não a pessoa que a submete
    grupoPesquisa: t(b.grupoPesquisa, 200),
