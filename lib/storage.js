...
async function initDriveStore() {
  ...
  // Grava agora e PROPAGA o erro: quem depende do dado estar salvo (a cobrança
  // do relatório, o encerramento do processo) precisa saber se falhou. Sem isso,
  // uma gravação feita nos 1,2 s antes do spin-down do Render morre em memória.
