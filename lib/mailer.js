    ...
    corpoHtml: `
      <div style="font-family:Segoe UI,Roboto,sans-serif;max-width:640px">
        ...
        <p>Assim que o pagamento for confirmado, você recebe outro e-mail com a credencial e o QR de acesso.
          Pix confirma em segundos; boleto, depois da compensação.</p>
 ...
 */
export function emailPagamentoDivergente(acao, inscrito, { pagoCentavos, devidoCentavos, pagamentoId } = {}) {
  const p = acao.proposta || {};
  return {
    ...
    corpoHtml: `
      <div style="font-family:Segoe UI,Roboto,sans-serif;max-width:640px">
        ...
        <p style="font-size:12.5px;color:#5b7280">Pagamento nº ${esc(pagamentoId || "—")} no Mercado Pago ·
