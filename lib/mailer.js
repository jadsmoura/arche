 ...
 */
export function emailPagamentoDivergente(acao, inscrito, { pagoCentavos, devidoCentavos, pagamentoId, provedor = "provedor de pagamento" } = {}) {
  const p = acao.proposta || {};
  return {
    para: process.env.EVENTOS_NOTIFY_EMAIL || "eventos@uniego.edu.br",
    assunto: `[ARCHÉ EV] Pagamento com valor diferente: ${p.nomeAtividade || acao.numeroAcao || ""}`,
    corpoHtml: `
      <div style="font-family:Segoe UI,Roboto,sans-serif;max-width:640px">
        <h2 style="color:#1c3742;margin-bottom:4px">Pagamento com valor diferente do devido</h2>
