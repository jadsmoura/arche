 ...
 */
export function emailInscricaoEvento(acao, inscrito, { baseUrl = "https://arche.app.br" } = {}) {
  const p = acao.proposta || {};
    ...
    corpoHtml: `
      <div style="font-family:Segoe UI,Roboto,sans-serif;max-width:640px">
        ...
        <div style="background:#e6f5fa;border-left:4px solid #40717e;border-radius:8px;padding:12px 16px;margin:14px 0">
          <b>No dia, apresente na entrada o QR da sua inscrição</b> — ele está na página
          abaixo. Se preferir, informe ao monitor o código <b style="font-family:monospace;letter-spacing:.08em">${esc(codigo)}</b>.
        </div>
        ...
        <p style="color:#5b7280;font-size:11px;margin-top:14px">Seus dados pessoais são tratados pela
          ...
          evento, nos termos da Lei nº 13.709/2018 (LGPD). Dúvidas: extensao@uniego.edu.br.</p>
      </div>`,
  };
}
