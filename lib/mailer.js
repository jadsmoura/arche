...
export async function mandarComRitmo(gmail, bruto) {
  let ultimo = null;
...
export async function enviarEmail({ para, assunto, corpoHtml, anexos, exato = false }) {
  ...
  await mandarComRitmo(gmail, bruto);
  try {
