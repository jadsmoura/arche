    ...
    },
    {
      ...
      itens: [
        ...
        { n: "3.2.", texto: "A inscrição do candidato(a) é feita por ele mesmo no ARCHÉ, em formulário próprio, "
          + "e nele serão informados:", alineas: [
        ...
        { n: "3.3.", texto: "Não há entrega de documentos em papel nem anexos: a regularidade da matrícula e o "
          + "histórico do candidato são conferidos pela Coordenação do Curso nos sistemas acadêmicos da "
          + "instituição, que já os detêm. O ARCHÉ emite, quando necessário, a Ficha de Inscrição em PDF com "
          + "os dados informados e a declaração firmada." },
...
/** O que está estranho e não trava — amarelo na tela da PROPPEX, que decide
    caso a caso. Documento anexado não entra aqui: a inscrição é toda pelo
    formulário (decisão do dono, ago/2026), e matrícula e histórico se
    conferem nos sistemas acadêmicos, que já os têm. */
