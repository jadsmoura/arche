...
export function normalizarBolsistaEM(b = {}, { base = null } = {}) {
  ...
  return {
    ...
    relatorio: {
      ...
      // o texto do relatório simplificado, quando o próprio bolsista o
      // entrega pelo portal (decisão do dono, ago/2026) — a gestão continua
      // podendo registrar entregas feitas em papel, aí sem texto
      texto: t(b.relatorio?.texto, 8000),
      porAluno: b.relatorio?.porAluno === true,
    },
