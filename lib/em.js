 ...
 * de cobrança nomeia e que o painel dele cobra.
 *
 * São duas coisas de naturezas diferentes: o RESPONSÁVEL, que todo bolsista
 * tem de informar, e a CONTA, que só existe para quem recebe bolsa. Juntá-las
 * numa função só é o que permite ao e-mail dizer a um voluntário o que falta
 * a ELE sem lhe pedir conta corrente, e a um bolsista do CNPq as duas coisas
 * numa mensagem só.
 */
export const faltaDoEstudanteEM = (b = {}) =>
  [...faltaDoResponsavelEM(b), ...faltaDadosBancariosEM(b)];
...
export function faltaNoBolsistaEM(b = {}, { incluirProjeto = true } = {}) {
  return [
    ...
    // o responsável sai da MESMA régua que o painel do estudante cobra —
    // duas listas do mesmo fato acabariam divergindo no primeiro campo novo
