...
export const ESPACOS_PADRAO = [
  { id: "auditorio-bloco-a", nome: "Auditório", local: "Bloco A", capacidade: 400,
    conflito: "unico", recursos: "Palco, som, projeção, ar-condicionado" },
  { id: "area-convivencia", nome: "Área de Convivência", local: "Campus", capacidade: 300,
    conflito: "unico", recursos: "Área aberta, ponto de energia" },
  { id: "quadra-esportes", nome: "Quadra de Esportes", local: "Área esportiva", capacidade: 300,
    conflito: "unico", recursos: "Arquibancada, vestiários" },
  { id: "mini-auditorio-bloco-a", nome: "Mini Auditório — Sala 100", local: "Bloco A", capacidade: 60,
    conflito: "unico", recursos: "Projeção, ar-condicionado" },
  { id: "mini-auditorio-1-bloco-e", nome: "Mini Auditório 1", local: "Bloco E", capacidade: 60,
    conflito: "unico", recursos: "Projeção, ar-condicionado" },
  { id: "mini-auditorio-2-bloco-e", nome: "Mini Auditório 2", local: "Bloco E", capacidade: 60,
    conflito: "unico", recursos: "Projeção, ar-condicionado" },
  { id: "mini-auditorio-3-bloco-e", nome: "Mini Auditório 3", local: "Bloco E", capacidade: 60,
    conflito: "unico", recursos: "Projeção, ar-condicionado" },
  { id: "sala-transmissao-odonto", nome: "Sala de Transmissão Simultânea (Odonto)", local: "Bloco E",
    capacidade: 20, conflito: "unico", recursos: "Câmeras, mesa de som, transmissão ao vivo" },
  { id: "sala-aula", nome: "Sala de Aula", local: "Blocos A a E", capacidade: 0,
  ...
  { id: "laboratorio-centro-tecnologico", nome: "Laboratório — Centro Tecnológico",
    local: "Centro Tecnológico", capacidade: 0, conflito: "por-detalhe",
  ...
  { id: "sala-reunioes-reitoria", nome: "Sala de Reuniões da Reitoria", local: "Reitoria",
    capacidade: 20, conflito: "unico", recursos: "Mesa de reunião, projeção" },
  { id: "sala-reunioes-coordenacao", nome: "Sala de Reuniões da Coordenação", local: "Conforme o curso",
    capacidade: 15, conflito: "por-detalhe",
...
export function validarReserva(r, { espacos = [], hoje = hojeLocalISO() } = {}) {
  const erros = [];
  ...
  if (!r.orgao) erros.push("Informe o órgão (curso, setor ou comunidade).");
...
export function reservaPublica(espacos, r) {
  return {
    ...
    atividade: r.atividade, orgao: r.orgao, status: r.status,
  };
}
