 ...
 * Resultados. O arquivo vive em public/pesquisa/docs (o setor exige login).
 * Edital antigo que entrar como histórico ganha aqui a sua linha.
 */
export const DOCUMENTOS_EDITAIS = {
  "01/2026": "/pesquisa/docs/edital-01-2026.pdf",
};
...
export function notaClassificacao({ notaProjeto, pontuacaoProducao } = {}) {
  ...
  const clOk = Number.isFinite(cl) ? Math.min(Math.max(cl, 0), PONTUACAO_MAXIMA) : 0;
